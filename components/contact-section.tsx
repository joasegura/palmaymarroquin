        ...
        >
          <motion.div variants={cardVariants}>
            <Card className="rounded-xl border-brand-green-primary/20">
              <CardHeader>
                <CardTitle className="font-serif text-brand-green-dark">{t.contact.form.submit}</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <motion.div className="space-y-8" variants={cardVariants}>
            <Card className="rounded-xl border-brand-green-primary/20">
              <CardContent className="p-6">
                <h3 className="font-serif text-xl font-normal text-brand-green-dark mb-6">{t.contact.info.title}</h3>
            ...
            <Card className="bg-brand-beige-secondary/50 rounded-xl border-brand-green-primary/20">
              <CardContent className="p-6">
                <h3 className="font-serif text-xl font-normal text-brand-green-dark mb-4">{t.contact.quickActions.title}</h3>
                <div className="space-y-3">
                  {[
                    { 
                      icon: Phone, 
                      text: t.contact.quickActions.call, 
                      action: () => window.open("tel:+543764235678", "_self")
                    },
                    { 
                      icon: Mail, 
                      text: t.contact.quickActions.whatsapp, 
                      action: () => window.open("https://wa.me/5491123456789?text=Hola, me interesa conocer más sobre sus servicios inmobiliarios", "_blank")
                    },
                    { 
                      icon: MapPin, 
                      text: isMapOpen ? t.contact.quickActions.hideMap : t.contact.quickActions.location, 
                        ...
                        <div className="p-3 bg-white">
                          <div className="flex flex-col items-center gap-2">
                            <div className="text-center">
                              <p className="font-medium text-brand-green-dark text-sm">Palma & Marroquín</p>
                              <p className="text-xs text-muted-foreground">Colón 1234, Corrientes</p>
                            </div>
                            <Button
                              onClick={() => window.open("https://maps.google.com/?q=Colón+1234,+Corrientes,+Argentina", "_blank")}
